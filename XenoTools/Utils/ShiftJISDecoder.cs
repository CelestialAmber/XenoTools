...
namespace XenoTools.Utils
{
	public class ShiftJISDecoder
	{
        ...
        public static string DecodeShiftJIS(byte[] data, int offset, bool bigEndian)
        {
            ...
            while (offset < data.Length && data[offset] != 0)
            {
                ...
                else
                {
                    //16 bit character id
                    ushort charId = 0;
                    if (bigEndian) charId = (ushort)((data[offset] << 8) + data[offset + 1]);
                    else charId = (ushort)((data[offset]) + (data[offset + 1] >> 8));

                   // Console.WriteLine("Char id: " + charId.ToString("X4"));

                    if(charId >= 0x8140 && charId <= 0x84BF)
                    {
                        str += mainTable1[charId - 0x8140];
                    }
                    else if (charId >= 0x8740 && charId <= 0x879F)
                    {
                        str += mainTable2[charId - 0x8740];
                    }
                    else if (charId >= 0x8890 && charId <= 0x9FFF)
                    {
                        str += mainTable3[charId - 0x8890];
                    }
                    else if(charId >= 0xE040 && charId <= 0xEAAF)
                    {
                        str += mainTable4[charId - 0xE040];
                    }
                    else if(charId >= 0xFA40 && charId <= 0xFC4F)
                    {
                        str += mainTable5[charId - 0xFA40];
                    }
                    else
                    {
                        Console.WriteLine("Invalid character, skipping");
                    }
                    offset += 2;
                }
            }
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '院','陰','隠','韻','吋','右','宇','烏','羽','迂','雨','卯','鵜','窺','丑','碓', //8940
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '魁','晦','械','海','灰','界','皆','絵','芥','蟹','開','階','貝','凱','劾','外', //8A40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '機','帰','毅','気','汽','畿','祈','季','稀','紀','徽','規','記','貴','起','軌', //8B40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '掘','窟','沓','靴','轡','窪','熊','隈','粂','栗','繰','桑','鍬','勲','君','薫', //8C40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '后','喉','坑','垢','好','孔','孝','宏','工','巧','巷','幸','広','庚','康','弘', //8D40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '察','拶','撮','擦','札','殺','薩','雑','皐','鯖','捌','錆','鮫','皿','晒','三', //8E40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '宗','就','州','修','愁','拾','洲','秀','秋','終','繍','習','臭','舟','蒐','衆', //8F40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '拭','植','殖','燭','織','職','色','触','食','蝕','辱','尻','伸','信','侵','唇', //9040
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '繊','羨','腺','舛','船','薦','詮','賎','践','選','遷','銭','銑','閃','鮮','前', //9140
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '叩','但','達','辰','奪','脱','巽','竪','辿','棚','谷','狸','鱈','樽','誰','丹', //9240
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '邸','鄭','釘','鼎','泥','摘','擢','敵','滴','的','笛','適','鏑','溺','哲','徹', //9340
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '如','尿','韮','任','妊','忍','認','濡','禰','祢','寧','葱','猫','熱','年','念', //9440
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '鼻','柊','稗','匹','疋','髭','彦','膝','菱','肘','弼','必','畢','筆','逼','桧', //9540
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '法','泡','烹','砲','縫','胞','芳','萌','蓬','蜂','褒','訪','豊','邦','鋒','飽', //9640
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '諭','輸','唯','佑','優','勇','友','宥','幽','悠','憂','揖','有','柚','湧','涌', //9740
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '蓮','連','錬','呂','魯','櫓','炉','賂','路','露','労','婁','廊','弄','朗','楼', //9840
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '僉','僊','傳','僂','僖','僞','僥','僭','僣','僮','價','僵','儉','儁','儂','儖', //9940
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '咫','哂','咤','咾','咼','哘','哥','哦','唏','唔','哽','哮','哭','哺','哢','唹', //9A40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '奸','妁','妝','佞','侫','妣','妲','姆','姨','姜','妍','姙','姚','娥','娟','娑', //9B40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '廖','廣','廝','廚','廛','廢','廡','廨','廩','廬','廱','廳','廰','廴','廸','廾', //9C40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '戞','戡','截','戮','戰','戲','戳','扁','扎','扞','扣','扛','扠','扨','扼','抂', //9D40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '曄','暸','曖','曚','曠','昿','曦','曩','曰','曵','曷','朏','朖','朞','朦','朧', //9E40
        ...
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        '檗','蘗','檻','櫃','櫂','檸','檳','檬','櫞','櫑','櫟','檪','櫚','櫪','櫻','欅', //9F40
        ...
        '瀨','炅','炫','焏','焄','煜','煆','煇','凞','燁','燾','犱','犾','猤','猪','獷',
        '玽','珉','珖','珣','珒','琇','珵','琦','琪','琩','琮','瑢','璉','璟','甁','畯',
        '皂','皜','皞','皛','皦','益','睆','劯','砡','硎','硤','硺','礰','礼','神',' ',
        '祥','禔','福','禛','竑','竧','靖','竫','箞','精','絈','絜','綷','綠','緖','繒',
        '罇','羡','羽','茁','荢','荿','菇','菶','葈','蒴','蕓','蕙','蕫','﨟','薰','蘒',
        '﨡','蠇','裵','訒','訷','詹','誧','誾','諟','諸','諶','譓','譿','賰','賴','贒',
        '赶','﨣','軏','﨤','逸','遧','郞','都','鄕','鄧','釚','釗','釞','釭','釮','釤',
        '釥','鈆','鈐','鈊','鈺','鉀','鈼','鉎','鉙','鉑','鈹','鉧','銧','鉷','鉸','鋧',
        '鋗','鋙','鋐','﨧','鋕','鋠','鋓','錥','錡','鋻','﨨','錞','鋿','錝','錂','鍰',
        '鍗','鎤','鏆','鏞','鏸','鐱','鑅','鑈','閒','隆','﨩','隝','隯','霳','霻','靃',
        '靍','靏','靑','靕','顗','顥','飯','飼','餧','館','馞','驎','髙',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
        ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
