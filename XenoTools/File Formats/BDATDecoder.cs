...
namespace XenoTools.FileFormats
{
	...
	public class BDATDecoder {

		public string[] DecodeBdat(byte[] data) {
			int offset = 0;
		...
		string ReadString(int offset, byte[] data) {
			string str = "";
		...
		string ReadShiftJISString(int offset, byte[] data) {
